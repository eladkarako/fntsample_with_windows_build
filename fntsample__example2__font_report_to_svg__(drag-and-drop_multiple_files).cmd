@echo off
::-----------------------------------------------------------
:: generates report of a font to a SVG.
:: (not always works as well as PDF)
...
:LOOP
  ...
  set "OUTPUT_FILE=%~f1.svg"
  set "OUTPUT_FILE=%OUTPUT_FILE:\=/%"
  set "OUTPUT_FILE=%OUTPUT_FILE::/=/%"
  set "OUTPUT_FILE=/cygdrive/%OUTPUT_FILE%"
  
  title [%~nx1 » %~nx1.svg]
  echo [INFO] %~nx1 » %~nx1.svg ... 1>&2

  call "fntsample.cmd"  "--font-file" "%FONT_FILE%"  "--svg"  "--output-file" "%OUTPUT_FILE%"
